...
export default class {
    ...
    expandReviews() {
        ...
        //console.log(this.$reviewTabLink);

        /* Custom Js Added for Accordion of Tabs */
            if(this.$reviewTabLink.hasClass("productDetailsView-section")) {
                this.$reviewTabLink.find(".productView-title").addClass("toggle-active");
                this.$reviewTabLink.find(".productView-description").slideDown(250);
            }
        /* Custom Js Added for Accordion of Tabs */
